...
const TILES: readonly Tile[] = [
  ...
  { path: 'data-table', title: 'Data Table', icon: 'pi pi-table', desc: '17 cell types · filters · multi-sort · nested · async · live · CSV export.' },
  ...
  { path: 'menu', title: 'Menu', icon: 'pi pi-bars', desc: 'Dropdown / Context menu.' },
  { path: 'steps', title: 'Steps / Wizard', icon: 'pi pi-step-forward', desc: '8 variants · sub-steps · validation · sticky buttons.' },
